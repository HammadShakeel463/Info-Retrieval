...
# Train an SVM classifier using the proposed features
...
#     if sarcasm_detected:
#         QMessageBox.information(window, "Result", "This tweet is sarcastic")
#     else:
#         QMessageBox.information(window, "Result", "This tweet is not sarcastic")
...
# # Set background image
# background_label = QLabel(window)
# background_image = QPixmap("background.jpg")  # Replace with your background image file path
# background_label.setPixmap(background_image)
# background_label.setGeometry(0, 0, 800, 400)  # Doubled the size of the background label
# background_label.setScaledContents(True)
...
# # Create the main window
# window = tk.Tk()
# window.title("Sarcasm Detection")

# # Create a label to display the project name
# project_label = tk.Label(window, text="Sarcasm Detection", font=("Arial", 16))
...
# # Create a button to process the user input
# process_button = tk.Button(window, text="Process", command=process_user_query)
...
# # Function to process user input and display the result
# def process_input():
#     user_tweet = input_entry.get()  # Get user input from the entry field
...
#     # Show the result in a message box
#     if sarcasm_detected:
#         messagebox.showinfo("Result", "This tweet is sarcastic")
#     else:
#         messagebox.showinfo("Result", "This tweet is not sarcastic")
...
#     if user_prediction_ngram_reduced[0] == 0 :
#         print("This tweet is not sarcastic ")
#     else:
#         print("This tweet is sarcastic")
#     s = user_tweet
